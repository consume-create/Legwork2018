<template>
  <div id="biz-widget" :class="slideClass" @scroll="onBizWidgetScroll">
    <div id="biz-widget-inner">
      <div class="biz-widget-narrow-col">
        <div class="biz-widget-narrow-sticky">
      ...
      <div class="biz-widget-wide-col">
        ...
        <div class="biz-widget-wide-block">
        ...
        <div class="biz-widget-wide-block block-stagger-right">
...
#biz-widget-inner
  ...
  .biz-widget-narrow-col
    grid-column: 3 / span 4
    position: relative

    .biz-widget-narrow-sticky
      position: sticky
      top: 20px
